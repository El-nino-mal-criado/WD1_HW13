...
def enter_data():
    ...
    while entry:
        ...
        if type_or_player == "basketball player":
            ...
            player.points = input("Enter th number of points of the player: ").strip()
            player.rebounds = input("Enter th number of rebounds of the player: ").strip()
            player.assists = input("Enter th number of assists of the player: ").strip()
            ...
            player.height_cm = input("Enter player's height in cm: ").strip()
            player.weight_kg = input("Enter player's weight in kg: ").strip()
            player.goals = input("Enter th number of goals of the player: ").strip()
            player.yellow_cards = input("Enter th number of yellow cards of the player: ").strip()
            player.red_cards = input("Enter th number of red cards of the player: ").strip()
